...
참고 : [GarbageValueExample.java](./example/GarbageValueExample.java)
...
참고 : [CharExample.java](./example/CharExample.java)
...
참고 : [LongExample.java](./example/LongExample.java)
...
참고 : [FloatDoubleExample.java](./example/FloatDoubleExmaple.java)
...
참고 : [PromotionExample.java](./example/PromotionExample.java)
...
참고 : [CastingExample.java](./example/CastingExample.java)

### 데이터 손실 방지
> Casting을 할때 주의할 점은 값의 손실이 발생하면 안된다는 것이다. 변환하기전에 우선 안전하게 값이 보존될 수 있는지
> 검사하는 것이 좋다.

참고 : [CheckValueBeforeCasting.java](./example/CheckValueBeforeCasting.java)
...
참고 : [FromIntToFloat.java](./example/FromIntToFloat.java) 
...
참고 : [OperationsPromotionExample.java](./example/OperationExample.java)
